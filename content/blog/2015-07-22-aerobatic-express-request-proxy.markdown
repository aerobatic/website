...
_This post is written by Ivan Storck, Director of Developer Relations at Aerobatic and is a cross-post from the Bitbucket Blog at [https://blog.bitbucket.org](https://blog.bitbucket.org)_
...
ready(function() {
  document.getElementById("hipchat").addEventListener("submit", submitter);
});
```
...
```json
{
  ...
  "version": "0.0.1",
  "description":
    "Demo of using express-request-proxy on Aerobatic.com hosted apps",
  "main": "index.html",
  "scripts": {
...
The router section specifies how various paths in your application work. Each path matches a module.
...
Let us know how it's working for you &mdash; and if you run into any roadblocks. Visit [our version](http://aerohip.aerobaticapp.com/) of this demo app to drop us a line!
