...
```json
{
  ...
  "description":
    "These helpful tips will make your lawn lush all summer long and the envy of your neighbors",
...
{{<cli "curl -H 'Accept:application/json' https://www.aerobatic.com/search?q=jekyll">}}
